...
Lightweight telegram-bot written in Python using [shingram](https://github.com/nouzumoto/shingram) for downloading .torrent files to directories depending on type of content.
